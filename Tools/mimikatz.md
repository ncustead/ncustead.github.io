...
*
    ...
    Open the Registry Editor (RegEdit.exe), and navigate to the registry key that is located at: HKEY\_LOCAL\_MACHINE\SYSTEM\CurrentControlSet\Control\Lsa and Set the value of the registry key to: “RunAsPPL”=dword:00000001.
*
...
privilege::debug sekurlsa::minidump lsass.dmp sekurlsa::logonpasswords
